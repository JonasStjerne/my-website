...
{#if loadElements}
  <main>
    <div class="position-relative vh-50">
        ...
        <div class="content">
          <div class="introContainer">
            <h1 class={meModelLoaded ? " animate__animated animate__fadeIn animate__delay-2s" : ""} aria-label="Hi">
              <span aria-hidden="true"> H</span><span aria-hidden="true">i</span>
            </h1>
            <div
              class={meModelLoaded
      ...
      <div id="waveBackground" style="background-image: url('assets/wave.png');" class="d-none d-md-block" />
    ...
    <div class="container-fluid p-0" style="background-color: var(--mainColor); margin-top: -2px; padding-top: 1px;">
      <div class="row py-5 py-md-0 g-0 w-100">
        <div class="col-12 col-md-6 d-flex  justify-content-center position-relative">
          <h3 class="skillsText text-white text-center m-auto text-md-start" data-aos="fade-in" data-aos-duration="800">
            I work in a lot of different technologies and love learning new ones
            {#if meModelLoaded}
              <div class="position-absolute w-100 h-100 start-0 top-0 underlineTarget" />
            {/if}
        ...
        <div class="col-10 col-md-8 col-lg-6" data-aos="fade-up" data-aos-duration="800">
          ...
          <div>
            <p>
              ...
              new technologies and be the best at what I do.
            </p>
            <br />
            <p>
              I’m currently working <a class="text-white" style="text-decoration: none;" href="https://trifork.com/"
                >@Trifork</a
              > as a full stack student programmer.
            </p>
            <br />
            <p>
              Feel free to <a class="text-white" href="#contactForm">contact me</a> if you have any questions or would like
              me to work on a project
            </p>
          </div>
        </div>
      </div>
